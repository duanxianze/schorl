...
if __name__=="__main__":
    ...
    if os.name=='nt':
        if platform.processor()=='Intel64 Family 6 Model 69 Stepping 1, GenuineIntel':
            self_cmd_line=['D:\\python2.7\\python.exe','Q:/scholar_articles/src/Journals_Task/journal_pdf_url_generators/Elsevier_generator_watchdog.py']
            proc_cmd_line=['D:\\python2.7\\python.exe','Q:/scholar_articles/src/Journals_Task/journal_pdf_url_generators/Elsevier_pdf_url_generator.py']
        elif platform.processor()=='Intel64 Family 6 Model 58 Stepping 9, GenuineIntel':
            self_cmd_line=['C:\\Python27\\python.exe','E:/scholar_articles/src/Journals_Task/journal_pdf_url_generators/Elsevier_generator_watchdog.py']
            proc_cmd_line=['C:\\Python27\\python.exe','E:/scholar_articles/src/Journals_Task/journal_pdf_url_generators/Elsevier_pdf_url_generator.py']
        else:
            pass
    else:
